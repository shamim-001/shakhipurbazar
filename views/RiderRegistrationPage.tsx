...
const RiderRegistrationPage = () => {
    const { language, registerRider } = useApp();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setError('');
        try {
            const newUser = await registerRider(formState);
            if (newUser) {
    ...
    const content = {
        en: {
            ...
            description: "Earn by offering Rent-a-Car or Ridesharing services.",
            ...
            password: "Password",
            submit: "Register as Driver",
            haveAccount: "Already have an account?",
            login: "Log In"
        },
        bn: {
            title: "রাইডার হিসেবে যোগ দিন",
            description: "রেন্ট-এ-কার বা রাইড শেয়ারিং সার্ভিস দিয়ে আয় করুন।",
            ...
            license: "ড্রাইভিং লাইসেন্স নম্বর",
            password: "পাসওয়ার্ড",
            submit: "ড্রাইভার হিসেবে নিবন্ধন করুন",
            ...
            <div className="max-w-xl mx-auto">
                <div className="text-center mb-10">
                    <div className="bg-rose-100 dark:bg-rose-900/30 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <TruckIcon className="w-8 h-8 text-rose-500" />
                    </div>
                ...
                <div className="mt-4 text-center space-y-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        Wanted to deliver products instead?{' '}
                        <a onClick={() => navigate('/delivery/register')} className="font-medium text-green-500 hover:text-green-600 cursor-pointer">
